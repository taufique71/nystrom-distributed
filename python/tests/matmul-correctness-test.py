...
from matrix import ParMat, matmul
...
if __name__ == '__main__':
    ...
    parser.add_argument("-p1", "--p1", type=int, required=True, help="Number of process grid rows")
    parser.add_argument("-p2", "--p2", type=int, required=True, help="Number of process grid columns")
    parser.add_argument("-p3", "--p3", type=int, required=True, help="Number of process grid fibers")
    parser.add_argument("-n1", "--n1", type=int, required=True, help="Number of rows in A")
    parser.add_argument("-n2", "--n2", type=int, required=True, help="Number of columns in A / Number of rows in B")
    parser.add_argument("-n3", "--n3", type=int, required=True, help="Number of columns in B")
